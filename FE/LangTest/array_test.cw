...
fun test_local_array() void:
    ...
    test\AssertEq#(a[1], 2_u8)
    test\AssertEq#(a[2], 3_u8)
    test\AssertEq#(a[3], 3_u8)
    test\AssertEq#(a[9], 3_u8)
    ;
...
global! global_count_state = 999_u32


fun global_count() u32:
    set global_count_state += 1
    return global_count_state
...
fun test_complex_init() void:
    ...
    test\AssertEq#(a[3], 1_u32)
    test\AssertEq#(a[4], 0_u32)
    test\AssertEq#(a[5], 1000_u32)
    test\AssertEq#(a[6], 1001_u32)
    test\AssertEq#(a[7], 1002_u32)
    test\AssertEq#(a[8], 1003_u32)
    test\AssertEq#(a[9], 1004_u32)
    ;
