...
type UntaggedUnion1 = union!(s32, void, type_ptr)
...
type UntaggedUnion3 = union!(bool, s32, s64)

static_assert size_of(UntaggedUnion2) == 8

type UntaggedUnion4 = union!(bool, s32)

static_assert size_of(UntaggedUnion4) == 4

pub type UntaggedUnion5 = union!(t2, t3, s8)

static_assert size_of(UntaggedUnion5) == 1

type UntaggedUnion6 = union!(bool, u16)

static_assert size_of(UntaggedUnion6) == 2

type UntaggedUnion = union!(bool, u64, u32, r32, r64, [32]u8)
