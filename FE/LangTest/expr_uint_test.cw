...
fun test_u64(a u64, b u64) void:
    ...
    test\AssertEq#(a | b, 0x9775577997755779_u64)
    test\AssertEq#(a & b, 0x0224422002244220_u64)
    test\AssertEq#(a ~ b, 0x9551155995511559_u64)
...
fun test_u32(a u32, b u32) void:
    ...
    test\AssertEq#(a | b, 0x97755779_u32)
    test\AssertEq#(a & b, 0x02244220_u32)
    test\AssertEq#(a ~ b, 0x95511559_u32)
...
fun test_u16(a u16, b u16) void:
    ...
    test\AssertEq#(a | b, 0x5335_u16)
    test\AssertEq#(a & b, 0x0220_u16)
    test\AssertEq#(a ~ b, 0x5115_u16)
