...
fun Test_Dim2() void:
    ...
    test::AssertTrue#(v64::eq(
        v64::ONES_vec2, v64::pmax(v64::X_vec2, v64::Y_vec2)))
    test::AssertTrue#(v64::eq(
        v64::ONES_vec2, v64::pmax(v64::ONES_vec2, v64::Y_vec2)))
    test::AssertTrue#(v64::eq(
        v64::ZERO_vec2, v64::pmin(v64::X_vec2, v64::Y_vec2)))
    test::AssertTrue#(v64::eq(
        v64::Y_vec2, v64::pmin(v64::ONES_vec2, v64::Y_vec2)))
...
fun Test_Dim3() void:
    ...
    test::AssertTrue#(v64::eq(
        v64::ONES_vec3,  v64::pmax(v64::pmax(v64::X_vec3, v64::Y_vec3), v64::Z_vec3)))
    test::AssertTrue#(v64::eq(
        v64::ONES_vec3, v64::pmax(v64::ONES_vec3, v64::Y_vec3)))
    test::AssertTrue#(v64::eq(
        v64::ZERO_vec3, v64::pmin(v64::X_vec3, v64::Y_vec3)))
    test::AssertTrue#(v64::eq(
        v64::Y_vec3, v64::pmin(v64::ONES_vec3, v64::Y_vec3)))
