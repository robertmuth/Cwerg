...
fun Test_Dim2() void:
    ...
    test::AssertTrue#(
            v64::eq(v64::ONES_vec2, v64::pmax(v64::X_vec2, v64::Y_vec2)))
    test::AssertTrue#(
            v64::eq(v64::ONES_vec2, v64::pmax(v64::ONES_vec2, v64::Y_vec2)))
    test::AssertTrue#(
            v64::eq(v64::ZERO_vec2, v64::pmin(v64::X_vec2, v64::Y_vec2)))
    test::AssertTrue#(
            v64::eq(v64::Y_vec2, v64::pmin(v64::ONES_vec2, v64::Y_vec2)))
    ...
    test::AssertTrue#(
            v64::eq(v64::ID_mat2, v64::mulmm(v64::ID_mat2, v64::ID_mat2)))
...
fun Test_Dim3() void:
    test::AssertTrue#(
            v64::eq(
                v64::ID_mat3, {v64::mat3: v64::X_vec3, v64::Y_vec3, v64::Z_vec3}))
    test::AssertTrue#(
            v64::eq(
                v64::ONES_vec3, v64::add(
                    v64::add(v64::X_vec3, v64::Y_vec3), v64::Z_vec3)))
    test::AssertTrue#(
            v64::eq(
                v64::X_vec3, v64::sub(
                    v64::sub(v64::ONES_vec3, v64::Y_vec3), v64::Z_vec3)))
    ...
    test::AssertTrue#(
            v64::eq(
                v64::ONES_vec3, v64::pmax(
                    v64::pmax(v64::X_vec3, v64::Y_vec3), v64::Z_vec3)))
    test::AssertTrue#(
            v64::eq(v64::ONES_vec3, v64::pmax(v64::ONES_vec3, v64::Y_vec3)))
    test::AssertTrue#(
            v64::eq(v64::ZERO_vec3, v64::pmin(v64::X_vec3, v64::Y_vec3)))
    test::AssertTrue#(
            v64::eq(v64::Y_vec3, v64::pmin(v64::ONES_vec3, v64::Y_vec3)))
    ...
    test::AssertTrue#(
            v64::eq(v64::ID_mat3, v64::mulmm(v64::ID_mat3, v64::ID_mat3)))
    ...
    test::AssertTrue#(
            v64::eq(
                v64::scaled(v64::Z_vec3, -1), v64::cross(
                    v64::Y_vec3, v64::X_vec3)))
...
fun Test_HitDim3() void:
    ...
    ; inside
    test::AssertTrue#(
            v64::CheckRayHitsSphere(ray_orig, ray_dir, {: 2, 1, 1}, 2, REL_ERR, @!
            hit))
    test::AssertGenericEq#(
            {cmp::r64r: hit.distance * hit.distance}, {cmp::r64r: 3, REL_ERR})
    if false:
        test::AssertTrue#(
                v64::CheckRayHitsSphere(
