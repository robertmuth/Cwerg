...
fun main(argc s32, argv ^^u8) s32:
    test::AssertGenericEq#(
            {cmp::r64r: trig::sin_restricted(0.0, 0.0, true)}, {
                cmp::r64r: 0.0, REL_ERR})
    test::AssertGenericEq#(
            {cmp::r64r: trig::sin_restricted(math::PI / 6.0, 0.0, true)},
            {cmp::r64r: 0.5, REL_ERR})
    test::AssertGenericEq#(
            {cmp::r64r: trig::sin_restricted(math::PI / 4.0, 0.0, true)},
            {cmp::r64r: math::SQRT_2 / 2, REL_ERR})
    test::AssertGenericEq#(
            {cmp::r64r: trig::sin_restricted(math::PI / 3.0, 0.0, true)},
            {cmp::r64r: math::SQRT_3 / 2, REL_ERR})
    test::AssertGenericEq#(
            {cmp::r64r: trig::sin_restricted(math::PI / 2.0, 0.0, true)},
            {cmp::r64r: 1.0, REL_ERR})
    test::AssertGenericEq#(
            {cmp::r64r: trig::cos_restricted(0.0, 0.0)}, {
                cmp::r64r: 1.0, REL_ERR})
    test::AssertGenericEq#(
