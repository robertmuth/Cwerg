...
const OPC ClusteredOpcodeTable[] = {
  // cluster 0,
  OPC::mul, OPC::mla, OPC::umull, OPC::umlal, OPC::smull, OPC::smlal, OPC::muls, OPC::mlas, OPC::umulls, OPC::umlals, OPC::smulls, OPC::smlals, OPC::mls, OPC::smlabb, OPC::smulbb, OPC::smlatb, OPC::smultb, OPC::smlabt, OPC::smulbt, OPC::smlatt, OPC::smultt, OPC::strex, OPC::ldrex, OPC::ldrh_imm_sub_post, OPC::ldrsb_imm_sub_post, OPC::ldrsh_imm_sub_post, OPC::strh_imm_sub_post, OPC::ldrd_imm_sub_post, OPC::strd_imm_sub_post, OPC::ldrh_reg_sub_post, OPC::ldrsb_reg_sub_post, OPC::ldrsh_reg_sub_post, OPC::strh_reg_sub_post, OPC::ldrd_reg_sub_post, OPC::strd_reg_sub_post, OPC::ldrh_imm_add_post, OPC::ldrsb_imm_add_post, OPC::ldrsh_imm_add_post, OPC::strh_imm_add_post, OPC::ldrd_imm_add_post, OPC::strd_imm_add_post, OPC::ldrh_reg_add_post, OPC::ldrsb_reg_add_post, OPC::ldrsh_reg_add_post, OPC::strh_reg_add_post, OPC::ldrd_reg_add_post, OPC::strd_reg_add_post, OPC::ldrh_imm_sub, OPC::ldrsb_imm_sub, OPC::ldrsh_imm_sub, OPC::strh_imm_sub, OPC::ldrd_imm_sub, OPC::strd_imm_sub, OPC::ldrh_reg_sub, OPC::ldrsb_reg_sub, OPC::ldrsh_reg_sub, OPC::strh_reg_sub, OPC::ldrd_reg_sub, OPC::strd_reg_sub, OPC::ldrh_imm_add, OPC::ldrsb_imm_add, OPC::ldrsh_imm_add, OPC::strh_imm_add, OPC::ldrd_imm_add, OPC::strd_imm_add, OPC::ldrh_reg_add, OPC::ldrsb_reg_add, OPC::ldrsh_reg_add, OPC::strh_reg_add, OPC::ldrd_reg_add, OPC::strd_reg_add, OPC::ldrh_imm_sub_pre, OPC::ldrsb_imm_sub_pre, OPC::ldrsh_imm_sub_pre, OPC::strh_imm_sub_pre, OPC::ldrd_imm_sub_pre, OPC::strd_imm_sub_pre, OPC::ldrh_reg_sub_pre, OPC::ldrsb_reg_sub_pre, OPC::ldrsh_reg_sub_pre, OPC::strh_reg_sub_pre, OPC::ldrd_reg_sub_pre, OPC::strd_reg_sub_pre, OPC::ldrh_imm_add_pre, OPC::ldrsb_imm_add_pre, OPC::ldrsh_imm_add_pre, OPC::strh_imm_add_pre, OPC::ldrd_imm_add_pre, OPC::strd_imm_add_pre, OPC::ldrh_reg_add_pre, OPC::ldrsb_reg_add_pre, OPC::ldrsh_reg_add_pre, OPC::strh_reg_add_pre, OPC::ldrd_reg_add_pre, OPC::strd_reg_add_pre, OPC::and_regreg, OPC::and_regimm, OPC::ands_regreg, OPC::ands_regimm, OPC::eor_regreg, OPC::eor_regimm, OPC::eors_regreg, OPC::eors_regimm, OPC::sub_regreg, OPC::sub_regimm, OPC::subs_regreg, OPC::subs_regimm, OPC::rsb_regreg, OPC::rsb_regimm, OPC::rsbs_regreg, OPC::rsbs_regimm, OPC::add_regreg, OPC::add_regimm, OPC::adds_regreg, OPC::adds_regimm, OPC::adc_regreg, OPC::adc_regimm, OPC::adcs_regreg, OPC::adcs_regimm, OPC::sbc_regreg, OPC::sbc_regimm, OPC::sbcs_regreg, OPC::sbcs_regimm, OPC::rsc_regreg, OPC::rsc_regimm, OPC::rscs_regreg, OPC::rscs_regimm, OPC::orr_regreg, OPC::orr_regimm, OPC::orrs_regreg, OPC::orrs_regimm, OPC::bic_regreg, OPC::bic_regimm, OPC::bics_regreg, OPC::bics_regimm, OPC::swp, OPC::swpb, OPC::bx, OPC::blx_reg, OPC::clz, OPC::tst_regreg, OPC::tst_regimm, OPC::teq_regreg, OPC::teq_regimm, OPC::cmp_regreg, OPC::cmp_regimm, OPC::cmn_regreg, OPC::cmn_regimm, OPC::mov_regreg, OPC::mov_regimm, OPC::movs_regreg, OPC::movs_regimm, OPC::mvn_regreg, OPC::mvn_regimm, OPC::mvns_regreg, OPC::mvns_regimm,
  // cluster 1,
  OPC::and_imm, OPC::ands_imm, OPC::eor_imm, OPC::eors_imm, OPC::sub_imm, OPC::subs_imm, OPC::rsb_imm, OPC::rsbs_imm, OPC::add_imm, OPC::adds_imm, OPC::adc_imm, OPC::adcs_imm, OPC::sbc_imm, OPC::sbcs_imm, OPC::rsc_imm, OPC::rscs_imm, OPC::orr_imm, OPC::orrs_imm, OPC::bic_imm, OPC::bics_imm, OPC::tst_imm, OPC::teq_imm, OPC::cmp_imm, OPC::cmn_imm, OPC::mov_imm, OPC::movs_imm, OPC::mvn_imm, OPC::mvns_imm, OPC::movw, OPC::movt,
  // cluster 2,
  OPC::ldp_imm_sub_post, OPC::ldr_imm_sub_post, OPC::str_imm_sub_post, OPC::ldrb_imm_sub_post, OPC::strb_imm_sub_post, OPC::ldp_imm_add_post, OPC::ldr_imm_add_post, OPC::str_imm_add_post, OPC::ldrb_imm_add_post, OPC::strb_imm_add_post, OPC::ldp_imm_sub, OPC::ldr_imm_sub, OPC::str_imm_sub, OPC::ldrb_imm_sub, OPC::strb_imm_sub, OPC::ldp_imm_add, OPC::ldr_imm_add, OPC::str_imm_add, OPC::ldrb_imm_add, OPC::strb_imm_add, OPC::ldp_imm_sub_pre, OPC::ldr_imm_sub_pre, OPC::str_imm_sub_pre, OPC::ldrb_imm_sub_pre, OPC::strb_imm_sub_pre, OPC::ldp_imm_add_pre, OPC::ldr_imm_add_pre, OPC::str_imm_add_pre, OPC::ldrb_imm_add_pre, OPC::strb_imm_add_pre,
  // cluster 3,
  OPC::sdiv, OPC::udiv, OPC::uxtb, OPC::sxtb, OPC::uxtab, OPC::sxtab, OPC::uxtb16, OPC::sxtb16, OPC::uxtab16, OPC::sxtab16, OPC::uxth, OPC::sxth, OPC::uxtah, OPC::sxtah, OPC::rev, OPC::rev16, OPC::ldp_reg_sub_post, OPC::ldr_reg_sub_post, OPC::str_reg_sub_post, OPC::ldrb_reg_sub_post, OPC::strb_reg_sub_post, OPC::ldp_reg_add_post, OPC::ldr_reg_add_post, OPC::str_reg_add_post, OPC::ldrb_reg_add_post, OPC::strb_reg_add_post, OPC::ldp_reg_sub, OPC::ldr_reg_sub, OPC::str_reg_sub, OPC::ldrb_reg_sub, OPC::strb_reg_sub, OPC::ldp_reg_add, OPC::ldr_reg_add, OPC::str_reg_add, OPC::ldrb_reg_add, OPC::strb_reg_add, OPC::ldp_reg_sub_pre, OPC::ldr_reg_sub_pre, OPC::str_reg_sub_pre, OPC::ldrb_reg_sub_pre, OPC::strb_reg_sub_pre, OPC::ldp_reg_add_pre, OPC::ldr_reg_add_pre, OPC::str_reg_add_pre, OPC::ldrb_reg_add_pre, OPC::strb_reg_add_pre, OPC::ud2,
  // cluster 4,
  OPC::stmda, OPC::ldmda, OPC::stmia, OPC::ldmia, OPC::stmdb, OPC::ldmdb, OPC::stmib, OPC::ldmib, OPC::stmda_update, OPC::ldmda_update, OPC::stmia_update, OPC::ldmia_update, OPC::stmdb_update, OPC::ldmdb_update, OPC::stmib_update, OPC::ldmib_update,
  // cluster 5,
  OPC::b, OPC::bl,
  // cluster 6,
  OPC::vldr_f32_sub, OPC::vldr_f64_sub, OPC::vstr_f32_sub, OPC::vstr_f64_sub, OPC::vldr_f32_add, OPC::vldr_f64_add, OPC::vstr_f32_add, OPC::vstr_f64_add, OPC::vmov_atof, OPC::vmov_ftoa, OPC::vldmda_s, OPC::vldmda_f, OPC::vstmda_s, OPC::vstmda_f, OPC::vldmia_s, OPC::vldmia_f, OPC::vstmia_s, OPC::vstmia_f, OPC::vldmdb_s, OPC::vldmdb_f, OPC::vstmdb_s, OPC::vstmdb_f, OPC::vldmib_s, OPC::vldmib_f, OPC::vstmib_s, OPC::vstmib_f, OPC::vldmda_s_update, OPC::vldmda_f_update, OPC::vstmda_s_update, OPC::vstmda_f_update, OPC::vldmia_s_update, OPC::vldmia_f_update, OPC::vstmia_s_update, OPC::vstmia_f_update, OPC::vldmdb_s_update, OPC::vldmdb_f_update, OPC::vstmdb_s_update, OPC::vstmdb_f_update, OPC::vldmib_s_update, OPC::vldmib_f_update, OPC::vstmib_s_update, OPC::vstmib_f_update,
  // cluster 7,
  OPC::svc, OPC::vmov_atos, OPC::vmov_stoa, OPC::vcvt_f32_f64, OPC::vcvt_f64_f32, OPC::vcvt_s32_f64, OPC::vcvt_s32_f32, OPC::vcvt_u32_f64, OPC::vcvt_u32_f32, OPC::vcvt_f64_s32, OPC::vcvt_f32_s32, OPC::vcvt_f64_u32, OPC::vcvt_f32_u32, OPC::vcmp_f32, OPC::vcmp_f64, OPC::vcmp_f32_zero, OPC::vcmp_f64_zero, OPC::vcmpe_f32, OPC::vcmpe_f64, OPC::vcmpe_f32_zero, OPC::vcmpe_f64_zero, OPC::vabs_f32, OPC::vabs_f64, OPC::vmov_f32, OPC::vmov_f64, OPC::vsqrt_f32, OPC::vsqrt_f64, OPC::vneg_f32, OPC::vneg_f64, OPC::vdiv_f32, OPC::vdiv_f64, OPC::vmul_f32, OPC::vmul_f64, OPC::vadd_f32, OPC::vadd_f64, OPC::vsub_f32, OPC::vsub_f64, OPC::vnmul_f32, OPC::vnmul_f64, OPC::vnmls_f32, OPC::vnmls_f64, OPC::vnmla_f32, OPC::vnmla_f64, OPC::vmls_f32, OPC::vmls_f64, OPC::vmla_f32, OPC::vmla_f64, OPC::vmrs_APSR_nzcv_fpscr
};
