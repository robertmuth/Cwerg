...
for ext, bits in [("8b", [(1, 0, 30), (3, 0, 22)]),
                  ("16b", [(1, 1, 30), (3, 0, 22)]),
                  ("4h", [(1, 0, 30), (3, 1, 22)]),
                  ("8h", [(1, 1, 30), (3, 1, 22)]),
                  ("4s", [(1, 1, 30), (3, 2, 22)])]:
    Opcode("uaddlv", ext, [root011, (1, 0, 31), (1, 1, 29), (3, 2, 24), (0xfff, 0xc0e, 10)] + bits,
           [OK.VREG_0_4, OK.VREG_5_9], OPC_FLAG(0))
...
for ext, bits in [("8b", [(1, 0, 30), (3, 0, 22)]),
                  ...
                  ("8h", [(1, 1, 30), (3, 1, 22)]),
                  ("4s", [(1, 1, 30), (3, 2, 22)])]:
    Opcode("cnt", ext, [root011, (1, 0, 31), (1, 0, 29), (3, 2, 24), (0xfff, 0x816, 10)] + bits,
           [OK.VREG_0_4, OK.VREG_5_9], OPC_FLAG(0))

for ext, bits in [("2d", [(1, 1, 30), (3, 3, 22)]),
                  ("16b", [(1, 1, 30), (3, 0, 22)])]:
    Opcode("pmull2", ext, [root011, (1, 0, 31), (1, 0, 29), (3, 2, 24), (1, 1, 21), (0x3f, 0x38, 10)] + bits,
           [OK.VREG_0_4, OK.VREG_5_9, OK.VREG_16_20], OPC_FLAG(0))

for ext, bits in [("1d", [(1, 0, 30), (3, 3, 22)]),
                  ("8b", [(1, 0, 30), (3, 0, 22)])]:
    Opcode("pmull", ext, [root011, (1, 0, 31), (1, 0, 29), (3, 2, 24), (1, 1, 21), (0x3f, 0x38, 10)] + bits,
           [OK.VREG_0_4, OK.VREG_5_9, OK.VREG_16_20], OPC_FLAG(0))
