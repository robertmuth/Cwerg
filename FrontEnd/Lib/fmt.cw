...
(fun u8_to_str [(param v u8) (param out (slice! u8))] uint :
    (return (unsigned_to_str# v 10 32_uint out)))


(fun u16_to_str [(param v u16) (param out (slice! u8))] uint :
    (return (unsigned_to_str# v 10 32_uint out)))


(fun u32_to_str [(param v u32) (param out (slice! u8))] uint :
    (return (unsigned_to_str# v 10 32_uint out)))


(fun u64_to_str [(param v u64) (param out (slice! u8))] uint :
    (return (unsigned_to_str# v 10 32_uint out)))


(fun s32_to_str [(param v s32) (param out (slice! u8))] uint :
    (if (== (len out) 0) :
        (return 0)
     :)
    (if (< v 0) :
...
(fun u32_to_hex_str [(param v u32) (param out (slice! u8))] uint :
    (return (unsigned_to_str# v 16 32_uint out)))


(fun u16_to_hex_str [(param v u16) (param out (slice! u8))] uint :
    (return (unsigned_to_str# v 16 32_uint out)))
...
(fun r64_to_hex_str [(param val r64) (param out (slice! u8))] uint :
